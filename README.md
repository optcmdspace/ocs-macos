...
2. Free the hotkey: macOS binds ⌥⌘Space to "Show Finder search window" by default. Open System Settings → Keyboard → Keyboard Shortcuts → Spotlight, and uncheck **Show Finder search window**.
